...
@section('header-table')
    ...
    <h6 class="m-0 font-weight-bold text-primary">Ruangan Tabel</h6>
@endsection
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 table-responsive">
                <table class="table table-striped table-bordered ruangan_datatable">
                    <thead>
                        <tr>
                            <th>ID</th>
                            <th>Name</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('.ruangan_datatable').DataTable({
            processing: true,
            serverSide: true,
        ...
        $('#sample_form').on('submit', function(event){
            ...
            if($('#action').val() == 'Add')
            {
                action_url = "{{ route('ruangan.store') }}";
            }

            if($('#action').val() == 'Edit')
            {
                action_url = "{{ route('ruangan.update') }}";
            }
        ...
        $(document).on('click', '.delete', function(){
            ...
            ruangan_id = $(this).attr('id');
            $('#confirmModal').modal('show');
        });

        $('#ok_button').click(function(){
            $.ajax({
                url:"/admin/ruangan/destroy/"+ruangan_id,
                beforeSend:function(){
